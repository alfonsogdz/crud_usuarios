...
<head>
    ...
    <link rel="stylesheet" href="vendor/assets/css/sb-admin-2.min.css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('comite') ?>">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav style="background-color: #1a237e;" class="navbar navbar-expand topbar mb-4 static-top shadow">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-end my-auto">
                        <span>Copyright &copy; JuventudesGto 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
